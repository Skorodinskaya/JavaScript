...
document.write(`<div class="total_simpsons">`);
for (const simpson of simpsons) {
    document.write(`<div class="item_simpson">
<h2>${simpson.name} ${simpson.surname}. Age is - ${simpson.age}</h2>
<p>${simpson.info}</p>
<img src="${simpson.photo}" alt="simp">
</div>`)
...
document.write(`<div class="product-total">`);
for (const product_item of products)
    document.write(
        `<div class="product-card">
<h3 class="product_title">${product_item.title}. Price - ${product_item.price}</h3>
<img src="${product_item.image}" alt="smth" class="product_image">
</div>`
    )
document.write(`</div>`);